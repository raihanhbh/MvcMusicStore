...
namespace MvcMusicStore.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,AlbumID,Contents,ReviewerEmail,ReviewerStar")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewID,AlbumID,Contents,ReviewerEmail,ReviewerStar")] Review review)
        {
            if (ModelState.IsValid)
            {
